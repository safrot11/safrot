    ...
    this.sendMessage(id, {
        ...
        mentionedJid: [user],
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://i.ibb.co/186SZYt/5730f2f9ac4e7e6d87a62a094ba86ae7.jpg',
                renderLargerThumbnail: true,
...
if (templ.gcImg) {
    ...
    this.sendMessage(id, {
        ...
        mentionedJid: [user],
            externalAdReply: {
                title: 'يلا المركب الي تودي مترجعش😹👋🏻',
                body: '',
                thumbnail: xnxx,
                sourceUrl: sgc,
                mediaType: 1,
...
انضم إلى مجموعة ♯ЅᗩFᏒOT꙯ للحصول على الوصول.\n\n> ${global.url.sgc}`,
        ...
        rowner: '> *\`『 الميزه دي للمطور بس يحب🧚🏻‍♂️ 』\`*',
...
function ucapan() {
  ...
  if (time >= 4) {
    res = "بوت سفࢪوت الكبيࢪ🧚🏻‍♂️ 🌄"
  }
  if (time >= 10) {
    res = "بوت سفࢪوت الكبيࢪ🧚🏻‍♂️ ☀️"
  }
  if (time >= 15) {
    res = "بوت سفࢪوت الكبيࢪ🧚🏻‍♂️ 🌇"
  }
